        ...
        execute: function () {
            LivroController = class LivroController {
                constructor() {
                    ...
                    this._inputAvaliacao = document.querySelector('#avaliacao');
                ...
                cadastrar(event) {
                    ...
                    let livro = new livro_1.Livro(this._inputTitulo.value, this._inputAutor.value, this._inputEditora.value, parseInt(this._inputAno.value), parseFloat(this._inputAvaliacao.value));
                    //console.log(livro);
